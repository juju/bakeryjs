...
export type ErrorInfo = {
  ...
  // This is deprecated - it is superceded by the InteractionMethods
  // field.
  LegacyWaitURL: string;
};

export type Error<I = void> = {
  Code: string;
  Message: string;
  Info: ErrorInfo & I;
};

export type MacaroonObject =
  | string
  | Uint8Array
  | MacaroonJSONV1
  | MacaroonJSONV2
  | (MacaroonJSONV1 | MacaroonJSONV2)[];
...
export declare class Macaroon {
  ...
  verify(
    rootKeyBytes: Uint8Array,
    check: (cond: string) => any,
    discharges?: Macaroon[]
  ): void;
  _verify(
    rootSigBits: sjcl.BitArray,
    rootKeyBits: sjcl.BitArray,
    check: (cond: string) => any,
    discharges: Macaroon[],
    used: number[]
  ): void;
...
/**
   ...
   @alias module:macaroon
 */
export declare const importMacaroons: (obj: MacaroonObject) => Macaroon[];
/**
   Create a new Macaroon with the given root key, identifier, location
   ...
   @alias module:macaroon
 */
export declare const newMacaroon: ({
  identifier,
  location,
  rootKey,
  version,
...
/**
   ...
   @alias module:macaroon
 */
export declare const dischargeMacaroon: (
  macaroon: Macaroon,
